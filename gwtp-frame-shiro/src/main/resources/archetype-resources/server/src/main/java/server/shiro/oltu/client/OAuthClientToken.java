package ${package}.server.shiro.oltu.client;
 ...
 * @author zqxu
 */
public class OAuthClientToken extends UsernamePasswordToken implements AuthenticationToken {
...
//    token.grantType = GrantType.AUTHORIZATION_CODE;
    token.grantType = GrantType.JWT_BEARER;
    return token;
  }
